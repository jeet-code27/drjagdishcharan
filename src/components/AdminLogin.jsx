  ...
  const AdminLogin = () => {
    ...
    const handleAcceptConsultation = async (booking) => {
      try {
        ...
        await emailjs.send(
          "service_wm05soa", // Replace with your EmailJS service ID
          "template_bw5l7jf", // Replace with your EmailJS template ID
          templateParams,
          "-Ik9ACjlNBUiyy8FL" // Replace with your EmailJS user ID
        );
