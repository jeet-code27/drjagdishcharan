...
export default function Home() {
   ...
   const faqs = [
  {
    ...
    a:
      "It’s a minimally invasive procedure that uses a tiny camera and tools through a small incision to treat spine problems like herniated discs or pinched nerves. Less cutting, faster healing, and minimal scarring.",
  },
  {
    q: "How is it different from traditional spine surgery?",
    a:
      "Traditional surgery usually involves large incisions, more tissue damage, and longer recovery. Endoscopic surgery uses small incisions and precise tools to reduce pain, blood loss, and downtime.",
  },
  {
    q: "What is arthroscopic surgery?",
    a:
      "It’s a keyhole surgery for joints (like the knee, shoulder, or hip). A small camera (arthroscope) and instruments are inserted through tiny cuts to diagnose and treat joint problems like torn cartilage or ligaments.",
  },
  {
    q: "Is recovery faster with endoscopic or arthroscopic surgery?",
    a:
      "Yes! Because the surgeries are minimally invasive, recovery time is usually shorter compared to open surgery. Most people go home the same day and return to normal activities much quicker.",
  },
  {
    q: "Are these procedures safe?",
    a:
      "When performed by experienced surgeons, yes—they’re very safe. In fact, there's often less risk of infection or complications compared to traditional open surgeries.",
  },
  {
    q: "How soon can I get back to work or daily activities?",
    a:
      "Many patients return to desk jobs in 1–2 weeks. Heavy lifting or physical jobs might need a few more weeks, depending on your healing and what was repaired.",
  },
  {
    q: "Is it covered by insurance?",
    a:
      "In most cases, yes—but coverage depends on your plan and the reason for the surgery. We’ll help you verify insurance and handle the paperwork for pre-authorization.",
  },
  {
    q: "Will the pain go away completely?",
    a:
      "For many patients, yes or significantly. The goal is to relieve nerve pressure or joint damage causing the pain. Every case is different, but outcomes are often life-changing.",
  },
];
...
<section className="grid grid-cols-1  gap-10 mt-16 mb-16 items-start">
  ...
  <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8">
    {/* What's Going On */}
    <div>
    <h2 className="text-3xl font-bold mb-4 text-gray-800">What's Causing the Pain?</h2>
    <p className="text-gray-700 leading-relaxed">
      Conditions like herniated discs, spinal stenosis, and nerve compression can turn simple movements into daily battles. When rest, medication, or therapy no longer cut it, the pain can take over your routine—and your peace of mind.
    </p>
  </div>

  {/* Solution */}
  <div>
    <h2 className="text-3xl font-bold mb-4 text-gray-800">How Endoscopic Surgery Helps</h2>
    <p className="text-gray-700 leading-relaxed">
      Endoscopic spine surgery uses a tiny incision and a high-definition camera to fix spinal problems with minimal damage to surrounding tissue. That means less pain, fewer scars, faster healing—and most patients walk out the same day.
    </p>
  </div>
  </div>
  ...
  <div className="w-full col-span-2 bg-gray-50 border-l-4 border-blue-500 rounded-3xl py-12 px-6 mt-8">
    ...
    <p className="text-lg text-center text-gray-600 mb-6 max-w-3xl mx-auto">
      Every spine is different, so we tailor our approach to your unique condition and lifestyle. Here’s how we guide you through recovery from first visit to full mobility.
    </p>
    <ul className="text-gray-700 space-y-3 max-w-3xl mx-auto list-disc list-inside">
      <li>Thorough imaging and diagnosis before we recommend surgery</li>
      <li>Minimally invasive procedures with small incisions</li>
      <li>Precision tools and camera-guided technique to avoid nerve damage</li>
      <li>Same-day discharge in most cases—no long hospital stays</li>
      <li>Step-by-step rehab support to help you regain movement safely</li>
      <li>Regular follow-ups to track your healing and answer questions</li>
    </ul>
  </div>
  ...
  <div className="w-full col-span-2 bg-gray-50 border-l-4 border-blue-500 rounded-3xl py-12 px-6">
    ...
    <p className="text-lg text-center text-gray-600 mb-6 max-w-3xl mx-auto">
      Endoscopic spine surgery isn’t just about fixing the problem—it’s about giving you your life back. Here’s what you can expect:
    </p>
    <ul className="text-gray-700 space-y-3 max-w-3xl mx-auto list-disc list-inside">
      ...
      <li>One-on-one care from a team that actually listens</li>
            ...
            <section className="mb-10">
              ...
              <p>
                Dr. Jagdish Singh Charan brings over 15 years of experience. Every consult is
                a conversation, not a lecture. Our clinic offers cutting-edge
                techniques, same-day discharges, and a support team that truly cares.
              </p>
            </section>
      ...
      <section className="mb-6">
        <p className="text-lg font-medium">
          Pain doesn’t define you. Book your consultation with  Dr. Jagdish Singh Charan
          today. Let’s get you moving, thriving, and living without limits.
        </p>
      </section>
    </main>
  );
